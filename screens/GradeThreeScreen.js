...
import GradeTwoData from "../data/GradeTwoData";
import GradeThreeData from "../data/GradeThreeData";
import { useNavigation } from "@react-navigation/native";

const GradeThreeScreen = () => {
  const navigation = useNavigation();
  const lastdata = GradeThreeData;
  return (
...
export default GradeThreeScreen
